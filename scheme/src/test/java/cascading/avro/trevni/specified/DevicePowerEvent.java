...
public class DevicePowerEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"DevicePowerEvent\",\"namespace\":\"cascading.avro.trevni.specified\",\"fields\":[{\"name\":\"power\",\"type\":\"double\"}]}");
  ...
  public static cascading.avro.trevni.specified.DevicePowerEvent.Builder newBuilder(cascading.avro.trevni.specified.DevicePowerEvent.Builder other) {
  ...
  public static cascading.avro.trevni.specified.DevicePowerEvent.Builder newBuilder(cascading.avro.trevni.specified.DevicePowerEvent other) {
    return new cascading.avro.trevni.specified.DevicePowerEvent.Builder(other);
  }
